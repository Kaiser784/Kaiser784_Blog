...
I'll be logging my Daily activity/logs on Obsidian locally and update it here as monthly logs. For the References section only some of the references I started out with that day are included, I didn't put all the rabbit hole articles or other ones but I did link some stuff which might give help with the basics of some of the things mentioned. I had to roll back on time some days because of University load hope that doesn't demotivate me.
